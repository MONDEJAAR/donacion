...
import com.optic.redsocial.providers.ImageProvider;
import com.optic.redsocial.providers.PostProvider;
import com.optic.redsocial.utils.FileUtil;
...
public class PostActivity extends AppCompatActivity {
    ...
    ImageView mImageViewClothes;
    ImageView mImageViewtoys;
    ImageView mImageViewfurniture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextInputTitle = findViewById(R.id.textInputarticle);
        mTextInputDescription = findViewById(R.id.textInputdescription);
        mImageViewbooks = findViewById(R.id.imageViewbooks);
        mImageViewClothes = findViewById(R.id.imageViewclothes);
        mImageViewtoys = findViewById(R.id.imageViewtoys);
        mImageViewfurniture = findViewById(R.id.imageViewfurniture);
        ...
        mImageViewClothes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "ROPA";
                mTextViewCategory.setText(mCategory);
        ...
        mImageViewtoys.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "JUGUETES";
                mTextViewCategory.setText(mCategory);
        ...
        mImageViewfurniture.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mCategory = "MUEBLES";
                mTextViewCategory.setText(mCategory);
    ...
    private void takePhoto() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoUri = FileProvider.getUriForFile(PostActivity.this, "com.optic.redsocial", photoFile);
    ...
    private void clearForm() {
        ...
        mImageViewPost1.setImageResource(R.drawable.uploadimg);
        mImageViewPost2.setImageResource(R.drawable.uploadimg);
        mTitle = "";
        mDescription = "";
        mCategory = "";
        mImageFile = null;
